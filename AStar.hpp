...
{	
    ...
    class AStar: public SearchAlgorithm<ProblemType, Hasher>
	{
        public:
			...
			AStar(const HeuristicFunctionType& heuristicFunction);
    ...
    template <typename ProblemType, typename Hasher>
    AStar<ProblemType, Hasher>::AStar(const HeuristicFunction<State, Cost>& heuristicFunction)
    ...
    template <typename ProblemType, typename Hasher>
    AStar<ProblemType, Hasher>::~AStar()
	{	
        delete heuristicFunction;
	}
	
    template <typename ProblemType, typename Hasher>
    typename AStar<ProblemType, Hasher>::SolutionPtr AStar<ProblemType, Hasher>::operator() ( const ProblemType& problem )
	{
    ...
    template <typename ProblemType, typename Hasher>
    typename AStar<ProblemType, Hasher>::FringeType* AStar<ProblemType, Hasher>::createFringe()
	{
